...
def obtenerFestivos(diccionario_festivos):
  now = datetime.now()
  ...
  return diccionario_festivos,conjunto_festivos
   
def crearArchivoFestivos (diccionario_festivos):
  if os.path.exists("ArchivosPickle/festivos"+str(datetime.now().year)+".pickle")==False: 
    diccionario_festivos,conjunto_festivos=obtenerFestivos(diccionario_festivos)
...
def esFestivo(fecha):
  ...
  es_festivo=False
  diccionario_festivos= crearArchivoFestivos(diccionario_festivos)
